...
<div id="popup1" class="overlay">
    <div class="popup">
        <h2>¡Enhorabuena!</h2>
        <h5>Has vendido producto</h5>
        <a class="close" href="/Profile">&times;</a>

        <%
            if(request.getAttribute("OpenChats").equals("Yes")){
        %>
        <form action="/Sold?FormComplete=yes" method="post">
            ...
            <div class="popUpContentHasMessages">
                <div class="userParent">
                    ...
                    >Usuario al que se lo has vendido</label
                    >
                        ...
                        <%
                            ...
                            for (Message message : messages) {
                                ...
                                if (idLoggedInUser != idOtroUsuario) {
                                    ...
                                    out.print("<option>"+otroUsuario.getNombre()+"</option>");
                ...
                <div class="starsContainer">
                    ...
                    <div class="qty mt-5">
                        ...
                        <label for="points"></label><input type="number" name="points" id="points" class="count" value="1" required/>
                        <span class="plus bg-dark" id="plus">+</span>
                    </div>
                </div>
                <div class="price">
                    <label for="price"></label><input type="number" name="price" id="price" required/>
                </div>
                <div class="review">
                    <textarea
                            id="reviewContent"
